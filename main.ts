...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    music.playSoundEffect(music.createSoundEffect(WaveShape.Noise, 3179, 3535, 255, 0, 500, SoundExpressionEffect.None, InterpolationCurve.Linear), SoundExpressionPlayMode.UntilDone)
})
function Starter () {
    ...
    ducky = sprites.create(assets.image`duck`, SpriteKind.bird)
    ducky.setVelocity(50, 50)
    ducky.setBounceOnWall(true)
    shotgun = sprites.create(assets.image`catboi`, SpriteKind.Player)
    shotgun.setBounceOnWall(true)
    shotgun.setPosition(25, 93)
    controller.player1.moveSprite(shotgun, 100, 100)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.collectable, function (sprite, otherSprite) {
    ...
    coin.destroy(effects.spray, 500)
    music.baDing.playUntilDone()
})
let Devil_dog: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    `)
game.showLongText("Welcome to duk/away, a dog will chase you, you are the cat, grab a coin for 150 points get to one thousand to win, you have 10 lives and a MINUTE AND A HALF to get that point score, otherwise, you will lose ", DialogLayout.Bottom)
Starter()
